...
import Final.Cashier;

public class EditPOS {// class name
	public static String admin[] = { "0", "bcas", "1111" };
	public static String cashier[] = { "1", "csd", "0000" };
	...
	private static void addproduct() {
		String[][] products = new String[customerNo][4];
